...
import { lotusAddressJson } from './index'
const props = defineProps<{
  lotusAddressData: any
}>()

console.log(props.lotusAddressData, '??', lotusAddressJson)
...
let events = defineEmits(['choseVal'])
const cancelPicker = () => {
  console.log(props.lotusAddressData)
...
const chosedVal = () => {}
const clickPicker = (a:any, b:any, c:any) => {
  console.log(a, b, c)
}
